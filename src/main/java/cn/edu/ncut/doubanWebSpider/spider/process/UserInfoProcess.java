...
public class UserInfoProcess implements PageProcessor
{
    ...
    public static final String COOKIE = "ll=\"108288\"; bid=2K6ma7aX0vI; gr_user_id=c19d1eb1-d082-4e08-9122-75b39a670114; OUTFOX_SEARCH_USER_ID_NCOO=1768112973.5807047; ps=y; ct=y; __utma=30149280.1676638126.1472372947.1472372947.1472380761.2; __utmz=30149280.1472372947.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); push_noty_num=0; push_doumail_num=0; as=\"https://read.douban.com/ebooks/tag/%E5%B0%8F%E8%AF%B4/\"; viewed=\"1770782_26382433_26698660_6082808_1008145_25862578_1500762_24375031_26381341_20491078\"; _vwo_uuid_v2=830216B642EE2BD6652E58F5EC0BC07B|aabaf5de9b2e6c0aa8d39eb855b8bcc0; ap=1; _pk_ref.100001.8cb4=%5B%22%22%2C%22%22%2C1472713406%2C%22https%3A%2F%2Fwww.baidu.com%2Flink%3Furl%3Do0xpiwdagqNjBEoIn4lrfBrTF4Y0n35GxR5o663MmVtnVMrtlsD-olMYlIqnuXWQ%26wd%3D%26eqid%3D9e325b84000240d50000000457be8a4f%22%5D; _pk_id.100001.8cb4=af8464f25c0c9491.1464750749.19.1472713406.1472620725.; _pk_ses.100001.8cb4=*";
    ...
    public void process(Page page)
    {
        ...
        try
        {
            ...
            String signature = page.getHtml().xpath("//div[@class='info']/h1/div[@class='signature_display pl']/text()").get().trim();
            String location = page.getHtml().xpath("//div[@class='user-info']/text()").get().trim();
            String joinTime = page.getHtml().xpath("//div[@class='user-info']/div[@class='p1']/text()").regex("d+-d+-d+").get().trim();
            ...
            user.setTime(new SimpleDateFormat("yyyy-MM-dd").parse(joinTime));
            user.setPic(pic);
